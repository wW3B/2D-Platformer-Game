...
public class Win implements Screen {
    ...
    private Music congrat;
    private Sound confirm;

    public Win(MyGame game) {
        this.game = game;
    ...
    public void render(float delta) {
        ...
        congrat = MyGame.manager.get("audio/music/victory.mp3",Music.class);
        congrat.play();
        
        
        Music musicam = MyGame.manager.get("audio/music/forest-am.mp3", Music.class);
        musicam.stop();
